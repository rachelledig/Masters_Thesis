...
```{r irrigationtypes, echo=FALSE,out.width="30%", out.height="20%",fig.cap="Different types of irrigation technologies (Source: Google Images, 2021)", fig.subcap = c("a) Furrow irrigaion", "b) Sprinkler irrigation", "c) Drip irrigation"), fig.show='hold',fig.align='center', fig.scap= "Different types of irrigation technologies."}
